...
{
    public partial class BancaComprobante
    {
        public BancaComprobante()
        {
            BancaComprobanteDs = new HashSet<BancaComprobanteD>();
        }
        ...
        public int? NotaCreditoExterna { get; set; }
        public int? BoletaExterna { get; set; }
        public int? Formato { get; set; }
        public int? Grupo { get; set; }
        public int? FlagDevolucion { get; set; }

        public virtual BancaInteraccion CinteraccionNavigation { get; set; }
        public virtual ICollection<BancaComprobanteD> BancaComprobanteDs { get; set; }
    }
}
