...
namespace InformeUNIDA.Models
{
    public partial class Evaluacion
    {
        public Evaluacion()
        {
            EvaluacionExoneras = new HashSet<EvaluacionExonera>();
        }
        ...
        public virtual Admision CadmisionNavigation { get; set; }
        public virtual Campanium CcampaniaNavigation { get; set; }
        public virtual ICollection<EvaluacionExonera> EvaluacionExoneras { get; set; }
    }
}
